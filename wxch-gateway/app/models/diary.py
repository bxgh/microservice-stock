...
class DiaryEntryCreate(BaseModel):
    entry_date: date
    entry_type: int = Field(default=5, description="1=盘前 2=盘中 3=盘后 4=周复盘 5=随笔 6=个股研究")
    mood: Optional[int] = Field(default=None, description="情绪 1=冷静 2=兴奋 3=焦虑 4=恐惧 5=贪婪 6=困惑")
    title: Optional[str] = None
    content: str
    content_format: str = "md_v1"
    visibility: int = Field(default=0, description="0=私密 1=链接可见 2=公开")
    is_pinned: bool = False
    stocks: List[str] = Field(default_factory=list, description="List of ts_codes")
